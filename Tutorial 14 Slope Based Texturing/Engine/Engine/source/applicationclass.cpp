...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), m_Direct3D->GetDeviceContext(), "../Engine/data/heightmap.bmp", "../Engine/data/grass.tga", "../Engine/data/slope.tga",
								   "../Engine/data/rock.tga");
	if(!result)
	{
